...
import { EditOutlined, DeleteOutlined, PlusOutlined } from '@ant-design/icons';  // Import PlusOutlined
  ...
  return (
    <div style={styles.container}>
      ...
      <Button
        ...
        onClick={() => navigate('/Leave/create')} // Navigate to CreateLeavePage
      >
